        ...
        <form>
          ...
          <fieldset class="form-group">
            <div class="col-lg-12">
              ...
              <input type="text" class="form-control" placeholder="封面图片" id="input-coverlink"v-model="newArticle.coverLink">
            </div>
          </fieldset>
          ...
          <fieldset class="form-group">
            <div class="col-lg-12">
              ...
              <textarea class="form-control" id="textarea-introduction" row="3" v-model="newArticle.introduction"></textarea>
            </div>
          </fieldset>
          ...
          <fieldset class="form-group">
            <div class="col-lg-12">
              ...
              <textarea class="form-control" id="textarea-content" row="10"
